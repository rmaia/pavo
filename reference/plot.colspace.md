...
- ...:
  ...
  additional graphical options, which vary by modeled `space`. Refer to
  their individual documentation:

  - [`diplot()`](https://pavo.colrverse.com/reference/diplot.md):
    dichromat space
  ...
  - [`catplot()`](https://pavo.colrverse.com/reference/catplot.md):
    categorical space

  - [`hexplot()`](https://pavo.colrverse.com/reference/hexplot.md):
    colour hexagon

  - [`cocplot()`](https://pavo.colrverse.com/reference/cocplot.md):
    colour-opponent-coding space

  - [`cieplot()`](https://pavo.colrverse.com/reference/cieplot.md): cie
    spaces

  - [`segplot()`](https://pavo.colrverse.com/reference/segplot.md):
    segment analysis space

  - [`jndplot()`](https://pavo.colrverse.com/reference/jndplot.md):
    perceptual, 'noise corrected' space (for the results of
    [`jnd2xyz()`](https://pavo.colrverse.com/reference/jnd2xyz.md))

  Also see [`par()`](https://rdrr.io/r/graphics/par.html).
