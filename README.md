...
[![cran version](https://www.r-pkg.org/badges/version-ago/pavo.png)](https://cran.r-project.org/package=pavo/) [![cran downloads](https://cranlogs.r-pkg.org/badges/grand-total/pavo.png)](https://cran.r-project.org/package=pavo/) [![R build status](https://github.com/rmaia/pavo/workflows/R-CMD-check/badge.svg)](https://github.com/rmaia/pavo/actions) [![cran checks](https://badges.cranchecks.info/worst/pavo.svg)](https://cran.r-project.org/web/checks/check_results_pavo.html) <!-- badges: end -->
