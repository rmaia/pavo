# Contributing to pavo

This outlines how to propose a change to pavo. For more detailed info
...
Please note that the pavo project is released with a [Contributor Code
of Conduct](https://pavo.colrverse.com/CODE_OF_CONDUCT.md). By
