...
`pavo` is now equipped with several new di-, tri- and tetrachromatic visual systems, to accompany the suite of new models. The full complement of included systems are, as always, accessable via the `vismodel()` option `visual`, and include:
