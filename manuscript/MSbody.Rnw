...
their colours, and compared both to their most recently diverged sister species, the sharp-tailed
...
and blue polyhedrons in Figure \ref{figure:volplot}). Interestingly, the wing plumage patch of
\emph{L. elisabeth} is more  similar to \emph{L. acutacaudus} than \emph{L. chloropterus}, to which
it is more closely related (dark grey circles in Figure \ref{figure:volplot}).
...
overlap between the two recently diverged species (Figure \ref{figure:overlapplot}:
