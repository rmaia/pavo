...
reflectance and the full width at half maximum, and can be fine-tuned to extract
...
peak sensitivity information \citep[available from the literature, e.g.][]{Hart:2005}, and can also
include oil droplet and retinal transmission information in the calculations
...
\citep{Vorobyev:1998,Vorobyev:1998to}.
