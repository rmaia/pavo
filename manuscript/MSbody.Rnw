...
\author{Rafael Maia\affil{1}\corrauth\, Pierre-Paul Bitton\affil{2}, Chad M. Eliason\affil{1}, Stephanie M. Doucet\affil{2}}
...
``receiver-independent'' objective quantification of an organism or object's color (REF, probably the bennett et al Am Nat). Over the
