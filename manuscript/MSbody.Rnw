...
rely on proprietary and/or closed software (REF). Further, published descriptions are often not
...
We introduce \pavo{} \textemdash \; a package for R (R REF) that aims at solving these problems by
...
color data under a variety of different models. We propose that, by combining these procedures under
