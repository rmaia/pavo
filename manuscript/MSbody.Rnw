...
sexual selection and social competition \citep{Rubenstein:2009}. Here we exemplify some of \pavo{}'s
...
deltas <- coldist(vm.star1, qcatch = 'fi', n1 = 1, n2 = 1.38, n3 = 3.34, n4 = 3.46, v = 0.1)
...
The calculation of both chromatic and achromatic distances of these 8,646 pairs of colours took about
...
overlap between the two recently diverged species (see Figure \ref{figure:volplot}):
