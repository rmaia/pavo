...
boxplot(H1~spp, subset(df, patch=="belly"), xlab="Species", ylab="Hue (nm)", xaxt='n', lty=1, lwd=1.5, cex.lab=1.2, col=pal)
axis(1, 1:3, levels(df$spp), cex.axis= 0.8, font=3, srt=45)
