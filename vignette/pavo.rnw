...
\pavo{} implements these calculations in the function \code{coldist}. For the achromatic contrast, \code{coldist} uses $\frac{v}{\sqrt{n_4}}$ as the value of $w$ for the achromatic contrast:

<<>>=
coldist(vismod1, vis='tetra', n1=1, n2=2, n3=2, n4=4, v=0.1)
coldist(vismod.idi, vis='di', n1=1, n2=1,  v=0.05)
@

Where \code{dS} is the chromatic contrast ($\Delta S$) and \code{dL} is the achromatic contrast ($\Delta L$).
