...
\begin{figure}[H]
\begin{center}
<<label=specsmooth,fig=TRUE,include=TRUE,results=hide,width=5,height=5>>=
...
\begin{figure}[H]
\begin{center}
<<Label=specnorm,fig=TRUE,include=TRUE,width=8,height=3>>=
# plot results
...
\begin{figure}[H] % h=here, t=top, b=bottom, p=floating page
\begin{center}
<<label=pcaplot,fig=TRUE,include=TRUE,width=6.3,height=3.3>>=
...
\begin{figure}[H] % h=here, t=top, b=bottom, p=floating page
\begin{center}
<<label=overlay,fig=TRUE,include=TRUE,width=4, height=4>>=
par(mar=c(4,4,2,2))
