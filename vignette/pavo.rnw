...
taxon of interest has color vision within the UV-human visible range. \code{summary} also takes 
an additional argument \code{subset} which if changed from the default \code{FALSE} to 
\code{TRUE} will return only the most commonly used colorimetrics \citep{Andersson:2006}.
...
\textcolor{red}{RM ADD INFO ON QIFI RETURN}
