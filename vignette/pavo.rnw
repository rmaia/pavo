...
\begin{center}
<<label=explorespecfig, fig=TRUE, include=TRUE, width=6, height=7>>=
...
\begin{figure}[H] % h=here, t=top, b=bottom, p=floating page
\begin{center}
<<label=exploresppmeans, fig=TRUE, include=TRUE>>=
...
\begin{figure}[H] % h=here, t=top, b=bottom, p=floating page
\begin{center}
<<label=fwhm, fig=TRUE, include=TRUE, width=5, height=3>>=
...
\begin{figure}[h] % h=here, t=top, b=bottom, p=floating page
\begin{center}
<<label=fwhm2, fig=TRUE, include=TRUE, height=3, width=3>>=
