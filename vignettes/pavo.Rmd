...
The raw spectral data used in this example are available from the package reporitory on [github](http://github.com), located [here](https://github.com/rmaia/pavo/blob/master/data_external/vignette). You can download and extract it to follow the vignette exactly. Alternatively, the data are included as an RData file as part of the package installation, and so can be loaded directly (see below).
