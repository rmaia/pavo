...
Below we will show the main functions in the package in an example workflow. The development version of `pavo` can be found on [github](https://github.com/rmaia/pavo).
