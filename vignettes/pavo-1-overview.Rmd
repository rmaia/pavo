...
A comprehensive tutorial to get you started with pavo is available in [the pavo handbook](https://bisaloo.github.io/colsci-book/). In this book, we begin by detailing the [importing, processing and visualisation](https://bisaloo.github.io/colsci-book/importing-processing-and-visualising-data.html) of spectral and image data, before moving on to discussion of the [flexible analyses](https://bisaloo.github.io/colsci-book/analysing-data.html) of such data that `pavo` allows. Our hope is to demonstrate the flexibility of `pavo`, and to provide a cohesive, reproducible workflow for colour pattern analysis within `R`. As always, the development version of `pavo` can be found on [github][pavo_repo], while the stable release is available via CRAN.
