...
```{r include = FALSE, eval=require("rgl")}
...
```{r, echo = FALSE, eval=require("rgl")}
rgl::bg3d("white") 
```

```{r, webshot::is_phantomjs_installed(), webgl=TRUE, eval=require("alphashape3d")}
plot(ashape_jnd)
```
...
```{r, eval = webshot::is_phantomjs_installed(), webgl=TRUE, eval=require("alphashape3d")}
